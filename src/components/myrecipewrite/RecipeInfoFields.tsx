    ...
    <div className="flex w-[712px] flex-col gap-y-5">
      ...
      <div className="flex gap-x-16">
        ...
        <input
          ...
          className="w-[528px] resize-none rounded-2xl bg-Gray-50 px-4 py-3 text-body-16 text-Gray-500"
        />
      </div>
      {/* 요리 소개 */}
      <div className="flex gap-x-16">
        ...
        <textarea
          className="h-[116px] w-[528px] resize-none rounded-2xl bg-Gray-50 px-4 py-3 text-body-16 text-Gray-500"
