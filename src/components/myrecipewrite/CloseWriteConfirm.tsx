            ...
            >
              <div className="flex flex-col items-center justify-center">
                ...
                <div className="mt-5 flex gap-3">
                  <button
                    className="flex h-[3rem] w-[9.0625rem] items-center justify-center gap-1 rounded-2xl border border-Primary-300 bg-white px-[0.75rem] py-[1rem] text-title-16 text-Primary-300"
                    onClick={() => setCloseWriteModal(false)}
                  >
                    돌아가기
                  </button>
                  <button
                    className="flex h-[3rem] w-[9.0625rem] items-center justify-center gap-1 rounded-2xl bg-orange-400 px-[0.75rem] py-[1rem] text-title-16 text-white"
                    onClick={(e) => {
                      e.preventDefault();
                      e.stopPropagation();
                      router.back();
