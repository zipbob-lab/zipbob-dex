  ...
  return (
    <div className="relative">
      <button
        ...
        className="flex h-[2rem] w-auto items-center justify-between rounded-3xl border-2 border-Gray-200 px-[1rem] py-[0.5rem] focus:border-Gray-500 focus:outline-none sm:w-[9rem] md:w-[12.5rem]"
      >
