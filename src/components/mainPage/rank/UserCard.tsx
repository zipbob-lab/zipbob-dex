...
const UserCard = ({ user, rank }: UserCardProps) => {
  return (
    <div>
      ...
      <div className="flex flex-col gap-[0.9rem] rounded-[1.25rem] p-4 shadow-[0px_4px_20px_0px_rgba(154,130,102,0.1)]">
        ...
        <p className="line-clamp-1 overflow-hidden text-center text-title-18 text-Gray-900">{user.user_nickname}</p>
